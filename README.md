...
![Gitlab pipeline status](https://img.shields.io/gitlab/pipeline-status/Stalis/birdwatch?branch=8-add-logging-by-zerolog-or-other&label=buid%208-add-logging-by-zerolog-or-other&style=flat-square)