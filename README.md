...
![Gitlab pipeline status](https://img.shields.io/gitlab/pipeline-status/Stalis/birdwatch?branch=7-parametrized-flags&label=buid%207-parametrized-flags&style=flat-square)