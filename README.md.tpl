...
![Gitlab pipeline status](https://img.shields.io/gitlab/pipeline-status/Stalis/birdwatch?branch={{ current.branch }}&label=buid%20{{ current.branch }}&style=flat-square)
